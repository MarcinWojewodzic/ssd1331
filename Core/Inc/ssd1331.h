...
#define ssd1331_cs_low GPIOA->BSRR=((uint32_t)cs_oled_Pin<<16)
#define ssd1331_dc_low GPIOA->BSRR=((uint32_t)dc_oled_Pin<<16)
#define ssd1331_rst_low GPIOC->BSRR=((uint32_t)rst_oled_Pin<<16)
#define ssd1331_cs_high  GPIOA->BSRR=((uint32_t)cs_oled_Pin)
#define ssd1331_dc_high  GPIOA->BSRR=((uint32_t)dc_oled_Pin)
#define ssd1331_rst_high  GPIOC->BSRR=((uint32_t)rst_oled_Pin)
