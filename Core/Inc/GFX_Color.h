...
#ifndef INC_GFX_COLOR_H_
#define INC_GFX_COLOR_H_
#define AVR_USING 0
#define STM32_USING 1
#define ILI_Color uint16_t
#define GFX_DrawPixel(x,y,color) setPixel( x, y, color);
#define WIDTH SSD1306_LCDWIDTH
#define HEIGHT SSD1306_LCDHEIGHT
#define PIXEL_BLACK	BLACK
#define PIXEL_ILI9341_WHITE	WHITE
